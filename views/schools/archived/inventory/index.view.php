...
<main class="main-col">
   <section class="flex items-center pr-12 gap-3">
      ...
      <a href="/coordinator/schools/archived">
   ...
   <form method="POST" action="/coordinator/schools/archived/inventory/<?= $id ?>/s">
                  ...
                  <td colspan="13" class="py-2 pr-4">
                     <div class="w-full flex items-center justify-end gap-2">
                        ...
                        <?php if ($pagination['pages_total'] > 1): ?>
                           <a
                              href="/coordinator/schools/archived/inventory/<?= $id ?>?page=1"
                              class="pagination-link">
                              <i class="bi bi-chevron-bar-left"></i>
                           </a>
                           <a
                              href="/coordinator/schools/archived/inventory/<?= $id ?>?page=<?= htmlspecialchars($pagination['pages_current'] <= 1 ? 1 : $pagination['pages_current'] - 1) ?>" class="pagination-link">
                              <i class="bi bi-chevron-left"></i>
                           </a>
                           <a href="/coordinator/schools/archived/inventory/<?= $id ?>?page=<?= htmlspecialchars($pagination['pages_current'] >= $pagination['pages_total'] ? $pagination['pages_total'] : $pagination['pages_current'] + 1) ?>"
                              class="pagination-link">
                              <i class="bi bi-chevron-right"></i>
                           </a>
                           <a href="/coordinator/schools/archived/inventory/<?= $id?>?page=<?= htmlspecialchars($pagination['pages_total']) ?>"
                              class="pagination-link">
