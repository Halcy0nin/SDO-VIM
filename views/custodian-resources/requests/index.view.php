...
<main class="main-col">
   ...
   <section class="mx-12 flex flex-col">
      ...
      <form class="search-container search" method="POST" action="/custodian/custodian-resources/requests/s">
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="h-full w-full flex items-center gap-2">
                              <?php require base_path('views/partials/custodian/custodian-resources/view_add_item_requests_modal.php'); ?>
                        </td>
                     </tr>
                  <?php endforeach; ?>
               <?php else: ?>
