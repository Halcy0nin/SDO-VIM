...
<main class="main-col">
   ...
   <section class="mx-12 mb-12 h-dvh rounded flex flex-col">
      ...
      <div class="search-container search">
         <form method="POST" action="/custodian/custodian-resources/working/s" > 
                  ...
                  <td colspan="6" class="py-2 pr-4">
                     <div class="w-full flex flex-wrap items-center justify-end gap-2">
                        ...
                        <?php if ($pagination['pages_total'] > 1): ?>
                           <a
                              href="/custodian/custodian-resources/working?page=1"
                              class="pagination-link">
                              <i class="bi bi-chevron-bar-left"></i>
                           </a>
                           <a
                              href="/custodian/custodian-resources/working?page=<?= htmlspecialchars($pagination['pages_current'] <= 1 ? 1 : $pagination['pages_current'] - 1) ?>" class="pagination-link">
                              <i class="bi bi-chevron-left"></i>
                           </a>
                           <a href="/custodian/custodian-resources/working?page=<?= htmlspecialchars($pagination['pages_current'] >= $pagination['pages_total'] ? $pagination['pages_total'] : $pagination['pages_current'] + 1) ?>"
                              class="pagination-link">
                              <i class="bi bi-chevron-right"></i>
                           </a>
                           <a href="/custodian/custodian-resources/working?page=<?= htmlspecialchars($pagination['pages_total']) ?>"
                              class="pagination-link">
