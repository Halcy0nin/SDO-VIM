...
<main class="main-col">
   ...
   <section class="mx-12 flex flex-col">
      <form class="search-container search" method="POST" action="/coordinator/logs/s">
               ...
               <?php if (count($activitylogs) > 0): ?>
                  <?php foreach ($activitylogs as $log): ?>
                     <tr>
                        ...
                        <td><?= htmlspecialchars($log['message'] ?? 'No Details') ?></td>
                        <td><?= htmlspecialchars(formatTimestamp($log['date_added'])) ?></td>
                     </tr>
                  <?php endforeach; ?>
               <?php else: ?>
                  <tr>
                  ...
                  <td colspan="6" class="py-2 pr-4">
                     <div class="w-full flex flex-wrap items-center justify-end gap-2">
                        ...
                        <?php if ($pagination['pages_total'] > 1): ?>
                           <a
                              href="/coordinator/logs?page=1"
                              class="pagination-link">
                              <i class="bi bi-chevron-bar-left"></i>
                           </a>
                           <a
                              href="/coordinator/logs?page=<?= htmlspecialchars($pagination['pages_current'] <= 1 ? 1 : $pagination['pages_current'] - 1) ?>" class="pagination-link">
                              <i class="bi bi-chevron-left"></i>
                           </a>
                           <a href="/coordinator/logs?page=<?= htmlspecialchars($pagination['pages_current'] >= $pagination['pages_total'] ? $pagination['pages_total'] : $pagination['pages_current'] + 1) ?>"
                              class="pagination-link">
                              <i class="bi bi-chevron-right"></i>
                           </a>
                           <a href="/coordinator/logs?page=<?= htmlspecialchars($pagination['pages_total']) ?>"
                              class="pagination-link">
