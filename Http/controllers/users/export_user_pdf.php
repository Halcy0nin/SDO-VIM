...
<page backtop="50mm" backbottom="30mm"> 
    ...
    <h1 style="margin:70; margin-top:0px;"> All Users Data </h1>
    <h4 style="margin: 0px; margin-top: -40px; margin-left: -40px;">Generated on: ' . $date . '</h4>
    <table class="table table-striped" style="width: 97%; word-wrap: break-word; overflow-wrap: break-word; border-collapse: collapse; margin-left: 0px; margin-top: 10px;">
        <thead>
            <tr>
                <th style="text-align: center; width: 10%; height: 7%; border: 2px solid black;">ID</th>
                ...
                <th style="text-align: center; width: 10%; border: 2px solid black;">School</th>
                <th style="text-align: center; width: 12%; border: 2px solid black;">Contact Name</th>
                <th style="text-align: center; width: 5%; border: 2px solid black;">Mobile Number</th>
                <th style="text-align: center; width: 18%; border: 2px solid black;">Email</th>
...
foreach ($users as $user) {
    $html .= '
        <tr>
            <td style="text-align: center;width: 10%; border: 2px solid black;">' . htmlspecialchars($user['user_id'] ?? '') . '</td>
            ...
            <td style="text-align: center; width: 14%; border: 2px solid black;">' . htmlspecialchars($user['school'] ?? '') . '</td>
            <td style="text-align: center; width: 12%; border: 2px solid black;">' . htmlspecialchars($user['contact_name'] ?? '') . '</td>
            <td style="text-align: center; width: 10%; border: 2px solid black;">' . htmlspecialchars($user['contact_no'] ?? '') . '</td>
            <td style="text-align: center; width: 18%; border: 2px solid black;">' . htmlspecialchars($user['contact_email'] ?? '') . '</td>
